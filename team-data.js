const teamData = {
  ant: {
    "小黑蟻": [
      ...
      { family: "91 小丑魚 / 珊瑚礁", child: "珍珠美人魚" },
      { family: "96 高山鯝魚 / 臺灣香魚", child: "櫻花鉤吻鮭" }
    ],
    "小黃蟻": [
      ...
      { family: "93 雨 / 陽光", child: "小狗" },
      { family: "94 暴龍 / 琥珀", child: "錢鼠" },
      { family: "95 山椒魚 / 豆娘", child: "始祖鳥" }
    ],
    "小綠蟻": [
      { family: "46 冬至 / 瓢蟲", child: "小美人魚" },
      { family: "47 海峽 / 野薑花", child: "小石虎" },
      { family: "56 角鯨 / 海鷗", child: "小蝙蝠" },
      { family: "71 海岸線 / 星辰花", child: "小金魚" }, // 🟢 已修正：從小黑蟻移過來
      { family: "97 地瓜 / 暗光鳥", child: "小馬" },
      { family: "98 土星 / 海棠", child: "珍珠" }
    ],
    "小紅蟻": [
      { family: "44 米蝦 / 珊瑚大戟", child: "捕蠅草" },
      { family: "61 薰衣草 / 花園鰻", child: "花園鰻" }, // 🟢 已修正：從小綠蟻移過來，請確認家庭名稱格式
  ...
  bee: {
    "泥壺蜂": [
      ...
      { family: "93 雨 / 陽光", child: "卡皮巴拉" }
    ],
    "虎頭蜂": [
      { family: "22 蟑螂 / 石榴", child: "狐獴" },
      { family: "31 Camel / 玄鳳", child: "黃金雉" },
